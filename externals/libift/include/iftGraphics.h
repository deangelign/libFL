...
void 	  iftDrawLabels(iftImage *img, iftImage *label, iftColorTable *cmap,	iftAdjRel *A, uchar fill, float alpha);
 ...
 */
void iftDrawBoundingBoxBordersInPlace(iftImage *img, iftBoundingBox bb, iftColor YCbCr);
