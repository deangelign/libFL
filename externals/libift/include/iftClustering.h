 ...
 * @param num_elements_for_dataset Number of elements to partition the big dataset in the first level
 ...
 * @note If the image isn't so big with two level will be enough
 * @returns The number of clusters found
 */
int iftDivideAndConquerUnsupOPF(iftDataSet *dataset, int num_elements_for_dataset, iftKnnGraphCutFun iftGraphCutFun, float k_max_percent, int hierarchy_level_count);

//void iftDivideAndConquerUnsupOPF2(iftDataSet *dataset, int num_elements_for_dataset, iftKnnGraphCutFun iftGraphCutFun, float k_max_percent);
 ...
 * @returns The number of clusters found
 */
int iftImageDivideAndConquerByBlocksUnsupOPF(iftDataSet *orig_dataset, int num_blocks, iftKnnGraphCutFun iftGraphCutFun, float k_max_percent, int hierarchy_level_count);
