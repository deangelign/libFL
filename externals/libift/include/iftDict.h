...
/**
 * @brief Checks if the dict contains the key.
 * @author Samuel Martins
 * @date Feb 16, 2016
 * @ingroup Dictionary
 *
...
/**
 * @brief Generic function to insertion of elements into a dictionary.
 * @author Samuel Martins
 * @date Feb 4th, 2016
 * @ingroup Dictionary
 *
...
/**
 * @brief Gets a COPY of the value from the dict based on its key.
 * @author Samuel Martins
 * @date Feb 12, 2016
 * @ingroup Dictionary
 *
...
#define iftGetStrValFromDict(KEY,DICT)      iftGetStrVal(iftGetGValFromDict(iftCreateGVal((KEY)), (DICT), IFT_STR_TYPE))
...
/**
 * @brief Read a dictionary from a JSON file.
 * @author Peixinho
 * @date April, 2016
 */
iftDict* iftReadDict(const char* filename, ...);


/**
 * @brief Writes dictionary to file in JSON format.
 * @author Peixinho
 * @date April, 2016
 */
void iftWriteDict(const iftDict* dict, const char* filename, ...);
